...
HEAD = "0007"  # Facility credit-status projection (0007) over the chain-projected history (0006)
...
def test_empty_database_to_head_and_back(fresh_db_url):
    ...
    assert len(_tables(fresh_db_url)) == 19 + 20 + 1 + 2 + 9 + 7 + 2 + 1  # projector + durable API + history + credit status
