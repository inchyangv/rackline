...
contract CheckpointManagerTest is Test {
    ...
    function test_setCheckpoint_success() public {
        vm.prank(owner);
        manager.setCheckpoint(BLOCK_HEIGHT_800000, BLOCK_HASH_800000, CHAIN_WORK_800000, TIMESTAMP_800000, BITS_800000);
    ...
    function test_setCheckpoint_emitsEvent() public {
        ...
        emit ICheckpointManager.CheckpointSet(
            BLOCK_HEIGHT_800000, BLOCK_HASH_800000, CHAIN_WORK_800000, TIMESTAMP_800000, BITS_800000
        );
    ...
    function test_setCheckpoint_revertsIfHeightNotIncreasing() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                CheckpointManager.HeightMustIncrease.selector, BLOCK_HEIGHT_800000, BLOCK_HEIGHT_800000
            )
        );
    ...
    function test_setCheckpoint_revertsIfHeightDecreasing() public {
        ...
        vm.prank(owner);
        manager.setCheckpoint(BLOCK_HEIGHT_800100, BLOCK_HASH_800100, CHAIN_WORK_800100, TIMESTAMP_800100, BITS_800100);

        // Try to set checkpoint with lower height
        vm.prank(owner);
        vm.expectRevert(
            abi.encodeWithSelector(
                CheckpointManager.HeightMustIncrease.selector, BLOCK_HEIGHT_800000, BLOCK_HEIGHT_800100
            )
        );
        manager.setCheckpoint(BLOCK_HEIGHT_800000, BLOCK_HASH_800000, CHAIN_WORK_800000, TIMESTAMP_800000, BITS_800000);
    }
    ...
    function test_setCheckpoint_revertsIfZeroBlockHash() public {
        ...
        manager.setCheckpoint(BLOCK_HEIGHT_800000, bytes32(0), CHAIN_WORK_800000, TIMESTAMP_800000, BITS_800000);
    }

    function test_setCheckpoint_revertsIfZeroTimestamp() public {
        vm.prank(owner);
        vm.expectRevert(CheckpointManager.InvalidTimestamp.selector);
        manager.setCheckpoint(BLOCK_HEIGHT_800000, BLOCK_HASH_800000, CHAIN_WORK_800000, 0, BITS_800000);
    }

    function test_setCheckpoint_revertsIfZeroBits() public {
        vm.prank(owner);
        vm.expectRevert(CheckpointManager.InvalidBits.selector);
        manager.setCheckpoint(BLOCK_HEIGHT_800000, BLOCK_HASH_800000, CHAIN_WORK_800000, TIMESTAMP_800000, 0);
    }

    // ============ getCheckpoint Tests ============

    function test_getCheckpoint_returnsZeroForNonExistent() public view {
        ICheckpointManager.Checkpoint memory cp = manager.getCheckpoint(999_999);
